...
const QuizModal: FC<QuizModalProps> = ({ 
  ...
  const handleAnswer = () => {
    ...
    try {
      ...
      // Reset state for next question - we'll do this after a successful answer
      // but we won't clear immediately since the parent component will handle the transition
    } catch (error) {
